...
<body>
<form action="../CustomerNavigator" method="get"><input type="submit" value="<<Back" class="btn btn-success"> </form>
	<form action="../EmployeeProcessor" method="get" class="well">
	<%
	...
	<center>
		...
		<table cellpadding="10px" cellspacing="10px" class="table-striped">
			...
			<tr>
				...
				<td>
				<td><input type="text" placeholder="Work Description" name="wDesc"  value="<%=emp.getWorkDesc()!=null?emp.getWorkDesc():""%>" class="form-control" required="true" >
				</td>
			</tr>
			<tr>
				<td>Hire Date</td>
	...
	<center>
		...
		<table cellpadding="10px" cells-spacing="10px" class="table-striped" class=" form-control">
			<tr>
				<td>
					Username
				</td>

...
<form action="../CustomerNavigator" method="get"><input type="submit" value="<<Back" class="btn btn-success"> </form>
	<form action="../CustomerProcessor" method="get" class="well">
		<%
			...
			<table cellpadding="10px" cellspacing="10px" class="table-striped">
				<tr>
					...
					<td><input type="text" placeholder="Social Security Info"
						...
						class="form-control" required="true" readonly></td>
				</tr>
				<tr>
					<td>Name</td>
			...
			<table cellpadding="10px" cellspacing="10px" class="table-striped"
				...
				<tr>
					...
					<td><input type="password" placeholder="CCNumber"
						name="uCC"
						value="<%=traveller.getCreditCardNum() != null ? traveller.getCreditCardNum()
					: ""%>"
						class="form-control" required="true" ></td>
				</tr>
			</table>

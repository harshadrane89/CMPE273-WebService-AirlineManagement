...
<body>
	<form action="../CustomerListProcessor" method="post" class="well">
		<%
			Traveller traveller = new Traveller();
			if (session.getAttribute("tSearchObj") != null) {
				traveller = (Traveller) session.getAttribute("tSearchObj");
			}
		%>
		<center>
			...
			<table cellpadding="10px" cellspacing="10px" class="table-striped">
				...
				<tr>
					<td>Date of Birth</td>
					<td>		<div class="input-append date input-group form-control" id="dp1"
							data-date="12-07-2012" data-date-format="mm-dd-yyyy">
							<input class="span2" name="dob" size="16" type="text"
								value="<%=traveller.getDob() != null ? traveller.getDob() : ""%>" > &nbsp;<span

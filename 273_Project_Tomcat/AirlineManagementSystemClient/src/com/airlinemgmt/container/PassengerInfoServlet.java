...
public class PassengerInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		Traveller[] temp=new Traveller[travellerObj.size()];
		for(int i=0;i<travellerObj.size();i++)
		{
			temp[i]=travellerObj.get(i);
		}
		reservation.setPassenger(temp);
	...
	protected void doPost(HttpServletRequest request,
		...
		Traveller[] temp=new Traveller[passengerInfo.size()];
		for(int i=0;i<passengerInfo.size();i++)
		{
			temp[i]=passengerInfo.get(i);
		}
		reservation.setPassenger(temp);

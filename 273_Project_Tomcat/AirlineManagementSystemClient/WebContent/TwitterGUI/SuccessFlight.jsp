...
<body>
<form action="../TicketNavigator" method="post" ><input type="submit" value="Done" class="btn btn-success"> </form>
	<%
	...
	<center>
		...
		<table class="table-striped" width="800px" cellpadding="10px">
			<thead>
				...
				%>
				<tr>
					<td><%=journey[i].getfName()%>&nbsp;<%=journey[i].getlName()%></td>
					<td><%=journey[i].getNationality()%></td>
					<td><%=journey[i].getPassNum()%></td>

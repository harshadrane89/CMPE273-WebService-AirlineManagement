...
<body>
	<form action="../CustomerReservationProcessor" method="post" class="well">
		<%
			...
			<table cellpadding="10px" cellspacing="10px" class="table-striped">
				...
				<tr>
					...
					<td><input type="text" placeholder="Minimum Fair"
						name="minFare" class="form-control" value="<%=journey.getMinFare() != null ? journey
					.getMinFare() : ""%>"></td>
					<td><input type="text" placeholder="Maximum Fair"
						name="maxFare" class="form-control" value="<%=journey.getMaxFare() != null ? journey
					.getMaxFare() : ""%>"></td>
				</tr>
				<tr>
					<td>Flight Date</td>
					<td>
						<div class="input-append date input-group" id="dp3"
							data-date="12-02-2012 " data-date-format="mm-dd-yyyy">
							<input class="span2 form-control" size="16" type="text" value="<%=journey.getDepartureDate() != null ? journey
					.getDepartureDate() : ""%>" 
								readonly placeholder="Travel Date" name="tDate"> &nbsp;<span class="add-on glyphicon glyphicon-calendar"></span>
						</div>
					</td>
				</tr>
			</table>
